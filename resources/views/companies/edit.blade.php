                                    ...
                                    <div class="form-group">
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" name="subject" value="{{ $company->subject }}" class="form-control"
                                            placeholder="subject">
                                        @error('subject')
                                    ...
                                    <div class="form-group">
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" name="author" value="{{ $company->author }}" class="form-control"
                                            placeholder="Author">
                                        @error('author')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" name="status" value="{{ $company->status }}" class="form-control"
                                            placeholder="Status">
                                        @error('status')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div  class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <a class="btn btn-outline-info" href="{{ route('companies.index') }}" enctype="multipart/form-data">
                                                Back</a>
                                            </div>
                                    </div>
                                </div>
