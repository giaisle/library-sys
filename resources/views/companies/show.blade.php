                                    ...
                                    <div class="form-group">
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                placeholder="Subject">{{ $company->subject }}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <p type="text" class="form-control" id="inlineFormInputGroup"
                                                    placeholder="Title">{{ $company->title }}
                                            </div>
                                        </div>
                                        {{-- <p type="text" class=""
                                    ...
                                    <div class="form-group">
                                        <div class="col-auto">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <p type="text" class="form-control" id="inlineFormInputGroup" placeholder="Author">
                                                    {{ $company->author }}</p>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="pull-right">
                                            <div class="col-auto">
                                                <a class="btn btn-outline-info" href="{{ route('companies.index') }}"
                                                enctype="multipart/form-data">
                                                Back</a>
                                                </div>
