                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container mt-2 py-6">
                        <div class="container mt-2">
                            ...
                            @endif
                            <form action="{{ route('patrons_models.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                <a class="btn btn-outline-info" href="{{ route('patrons_models.index') }}"> Back</a>
                                            </div>
                                        </div>
                                    </div>
